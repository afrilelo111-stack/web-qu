...
export default function LoginPage() {
  ...
  return (
    ...
    <div className="flex min-h-screen bg-[#FFDE4D] text-black items-center justify-center p-4 md:p-10 relative font-sans selection:bg-black selection:text-[#FFDE4D] overflow-x-hidden">
      ...
      <div className="w-full max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 z-10">
        ...
        {/* ─── SISI KIRI: TEKS SAMBUTAN UTAMA UNIVERSAL (Sistem Celengan Multi-Target) ─── */}
        <motion.div 
        ...
        >
          ...
          <div className="bg-[#6BCB77] border-4 border-black px-4 py-2 uppercase font-black tracking-wider text-xs shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rotate-[-2deg]">
            💰 Konsol Finansial & Celengan Digital
          </div>
          
          <h1 className="text-4xl md:text-6xl font-black tracking-tight leading-none uppercase">
            Wujudkan <br />
            Impian <span className="bg-[#4D96FF] text-black px-3 border-4 border-black inline-block transform rotate-[1deg] shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">Finansialku</span>
          </h1>
          
          <p className="text-black text-sm font-bold max-w-sm leading-relaxed bg-[#fff9db] border-3 border-black p-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            Masuk ke ekosistem Keugan untuk memantau, mengelola, dan mempercepat semua target tabungan serta impian masa depanmu dalam satu dashboard.
          </p>
        </motion.div>

        {/* ─── SISI KANAN: KAPSUL LOGIN NEO-BRUTALISM (Warna Kuning Mentega Ganti Putih Polos) ─── */}
        <motion.div 
          initial={{ opacity: 0, x: 50 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ type: "spring", stiffness: 150, damping: 15 }}
          className="w-full md:w-[450px] bg-[#fff9db] border-4 border-black p-8 md:p-10 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] relative"
        >
          
          {/* Label mini verifikasi keamanan */}
          <div className="flex justify-center md:justify-start mb-6">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 border-2 border-black bg-[#20c997] text-white text-xs font-black tracking-wider uppercase shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
              <Sparkles size={12} />
          ...
          <div className="mt-8 pt-5 border-t-4 border-black flex flex-col items-center gap-4 text-center">
            ...
            <p className="text-[10px] font-black uppercase tracking-widest text-neutral-600">
              Keugan Environment v1.0.0 — MULTI-TARGET FINANCIAL SYSTEM
            </p>
          </div>
